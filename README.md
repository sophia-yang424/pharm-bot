...
Create a .env file in the same directory as this project, with your Databricks server hostname, HTTP path, user token, and OpenAI key. If you are using the search_branch, then you also need to add a TAVILY API key
